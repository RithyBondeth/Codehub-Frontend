    ...
    return (
        <div className="my-10 flex flex-col justify-start gap-10">
            <div className="flex justify-between items-stretch gap-5 tablet-md:flex-col tablet-md:items-center">
                <div id={`${!isOpen && 'profile-box'}`} className="w-[35%] flex flex-col items-center tablet-md:w-1/2">
                    <img src="/src/assets/introduction/bondeth.jpg" alt="Codehub Founder" className="w-full"/>
                ...
                <div id={`${!isOpen && 'description-box'}`}  className="w-[65%] leading-10 px-5 text-md text-gray-500 tablet-md:w-full">
