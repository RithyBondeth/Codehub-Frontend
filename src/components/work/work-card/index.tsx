...
export default function WorkCard(props: WorkCardProps) {
    ...
    return (
        <div className="flex flex-col justify-between p-3 shadow-normal duration-300 hover:shadow-3d-primary">
            <img src={props.poster} alt="course-image" className="h-40 duration-300 hover:scale-105 tablet-lg:min-h-44 tablet-xl:h-32"/>
            <Divider/>
